...
| 版本 | 原版本 | 日期 | 主要内容 |
| --- | --- | --- | --- |
| 0.1.0 | Unity 0.5.0-alpha | 2024-03-04 | 首个 Android 测试版本 |
| 0.2.0 | Unity 0.5.0-beta | 2024-05-23 | 玩家、生存、存储和熔炼更新；Unity 最终版本 |

首个规范化 GitHub Release 为 `0.1.0`。后续版本将在确认后发布。
